print('Lets find the sum of two numbers')
number1 = 1.5
number2 = 3.5
sum = number2 + number1
...
print('Lets find the subtraction of two numbers and take the input from users')
...
print('Lets find the multiplication of two numbers and take the input from users')
...
print('Lets find the Division of two numbers and take the input from users')
